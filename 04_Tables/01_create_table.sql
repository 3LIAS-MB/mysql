...
-- Las tablas en la gran mayoria de los casos las tables tienen algo que se llama "Constraint";
-- son restricciones de la tabla que la van a hacer especial -> NOT NULL, 
...
CREATE TABLE persons4 (
    ...
    UNIQUE(id),
    /* 
    va a ser único y se convierte en la clave primaria, esto sirve para cuando queramos establecer relaciones con otras tablas, este va a ser el campo principal que va a servir para designar cada uno de los registros*/
    PRIMARY KEY(id) 
);

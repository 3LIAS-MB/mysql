/*
Concepto: Un trigger es un conjunto de instrucciones SQL que se ejecuta automáticamente en respuesta a ciertos eventos en una tabla, como inserciones, actualizaciones o eliminaciones.

Para qué sirve:

Implementa lógica de negocios a nivel de base de datos.
Mantiene la integridad referencial y de datos.
Audita cambios y registra el historial de operaciones.
*/
...
BEFORE/AFTER INSERT/UPDATE/DALETE
ON users
